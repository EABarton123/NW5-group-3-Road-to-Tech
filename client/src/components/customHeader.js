...
function CustomHeader({MenuItemTexts}) {
  return(
    <div className='MenuRow'>
         ...
         <img style={{marginRight:"100px",marginLeft:"10px",padding:0,borderRadius:15}}
         width={190} height={70} src={logo}></img>
     
    {
    MenuItemTexts.map((item) => {
   
       
       return <div  key={item} id={item}><MenuItem menuText={item} /></div>
      })
    }
